...
+ (NSString *)transformToHanyuPinyin:(NSString *)chinese
{
...
+(NSString *)defaultPinyinForString:(NSString *)originalString{
    ...
    NSString *pinyin = [self toHanyuPinyinStringWithNSString:originalString withHanyuPinyinOutputFormat:formatter withNSString:@""];
    return pinyin;
}
