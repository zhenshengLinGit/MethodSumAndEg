...
NSString *const MJRefreshHeaderRefreshingText = @"数据加载中...";

NSString *const MJRefreshAutoFooterIdleText = @"点击或上拉加载更多";
NSString *const MJRefreshAutoFooterRefreshingText = @"数据加载中...";
...
NSString *const MJRefreshBackFooterRefreshingText = @"数据加载中...";
